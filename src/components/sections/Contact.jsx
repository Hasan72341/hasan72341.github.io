        ...
        >
            <div className="mt-10 md:mt-20">
                <div className="overflow-hidden mb-2">
                    <SmoothReveal>
                        <span className="label-text-premium !text-primary/60 block">
                            Got a project?
                        </span>
                    </SmoothReveal>
                </div>
                ...
                <div className="relative group inline-block">
                    <a
                        ...
                        className="text-6xl sm:text-7xl md:text-[8vw] leading-[0.9] font-black tracking-tighter text-primary hover:text-primary/70 transition-colors duration-500 block w-fit break-words max-w-full font-amiamie uppercase"
                    >
                        LET'S TALK
                    </a>
            ...
            <div ref={infoRef} className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-12 mt-16 md:mt-0 border-t border-primary/10 pt-10">
                <div className="col-span-1 md:col-span-2">
                    <h3 className="label-text-premium mb-4 md:mb-6 !text-primary/60">Contact Details</h3>
                    <a href={`mailto:${data.email.trim()}`} className="text-xl md:text-3xl font-bold block w-fit hover:underline decoration-1 underline-offset-4 break-all transition-colors">{data.email}</a>
                    {data.phone && <p className="text-lg md:text-xl text-primary/60 mt-2">{data.phone}</p>}
                </div>

                <div>
                    <h3 className="label-text-premium mb-4 md:mb-6 !text-primary/60">Socials</h3>
                    <div className="flex flex-col gap-4 text-lg">
                        <a href={`https://${data.linkedin}`} target="_blank" rel="noreferrer" className="hover:text-primary/60 transition-colors flex items-center gap-3 group w-max">
                        ...
                        <a href={`https://${data.github}`} target="_blank" rel="noreferrer" className="hover:text-primary/60 transition-colors flex items-center gap-3 group w-max">
                            <div className="w-8 h-8 rounded-full border border-primary/20 flex items-center justify-center group-hover:bg-primary group-hover:border-primary transition-all duration-300">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="group-hover:text-darkLava transition-colors">
                ...
                <div>
                    <h3 className="label-text-premium mb-4 md:mb-6 !text-primary/60">Status</h3>
                    <div className="flex items-center gap-2 mt-2">
                        <span className="w-2.5 h-2.5 bg-green-500 rounded-full animate-pulse"></span>
                        <span className="text-lg text-primary/60">Open for opportunities</span>
                    </div>
                </div>
            </div>

            <div className="flex justify-between items-end mt-16 md:mt-0">
                <span className="text-xs text-primary/40 font-mono whitespace-nowrap">
                    © 2025 MD HASAN RAZA
                </span>
