    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="bg-[#f5f5f0] w-full max-w-7xl h-full md:h-[90vh] md:rounded-[2.5rem] overflow-hidden shadow-2xl flex flex-col relative border border-white/5"
        ...
        >
            ...
            >
                <div className="flex flex-col md:flex-row min-h-full">
                    ...
                    <div className="w-full md:w-[42%] bg-black text-[#f5f5f0] p-8 md:p-16 flex flex-col justify-between relative min-h-[50vh] md:min-h-full overflow-hidden">
                        ...
                        <motion.div custom={2} variants={contentVariants} initial="hidden" animate="visible" className="relative z-10 mt-12">
                             <a 
                                ...
                                className="group/btn inline-flex items-center gap-4 py-5 px-8 bg-[#f5f5f0] text-black rounded-2xl hover:bg-white transition-all duration-500 hover:shadow-[0_0_30px_rgba(255,255,255,0.2)]"
                            >
                    ...
                    {/* RIGHT PANEL - Content */}
                    <div className="w-full md:w-[58%] p-8 md:p-20 bg-[#f5f5f0] text-black overflow-hidden">
